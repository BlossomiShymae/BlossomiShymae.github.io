<template>
  <div class="position-relative">
    <aside class="d-flex flex-column justify-content-start align-items-center p-4 border border-accent border-2 gap-2">
    ...
    <header
      class="sticky-top py-2 border-bottom border-accent"
    >
